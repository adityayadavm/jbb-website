...
const relatedServices = [
  ...
  { icon: ClipboardCheck,  title: "Business Support Services",          desc: "Secretarial & ROC compliances, payroll, internal audit, and more.", href: "/services/business-support-services" },
  { icon: Briefcase,       title: "Transaction Advisory Services",      desc: "M&A advisory, due diligence, business valuation, and deal structuring.", href: "/services/transaction-advisory-services" },
  { icon: Landmark,        title: "Accounting, Reporting & Assurance",  desc: "Bookkeeping, financial statements, MIS reporting, and assurance review.", href: "/services/accounting-reporting-assurance" },
];
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(rgba(5,10,20,0.55), rgba(5,10,20,0.55)), url('/bg/direct-taxes-hero.jpg') center center / cover no-repeat",
        }}
      >
