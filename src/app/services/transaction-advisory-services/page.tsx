...
const relatedServices = [
  { icon: ClipboardCheck, title: "Accounting, Reporting & Assurance",  desc: "Bookkeeping, financial statements, assurance review, and Fractional CFO.", href: "/services/accounting-reporting-assurance" },
  { icon: FileSpreadsheet,title: "Goods and Services Tax",             desc: "GSTR filing, ITC reconciliation, GST audit, and notice handling.", href: "/services/goods-and-services-tax" },
  { icon: Building2,      title: "Business Support Services",          desc: "Secretarial & ROC compliances, payroll, internal audit, and fixed assets.", href: "/services/business-support-services" },
  { icon: Globe,          title: "Direct Taxes & Compliance",          desc: "Corporate tax, transfer pricing, international tax, and representation.", href: "/services/direct-taxes-compliance" },
];
  ...
  return (
    <>
      <section
        ...
        style={{
          background: "linear-gradient(rgba(5,10,20,0.62), rgba(5,10,20,0.62)), url('/bg/transaction-advisory-hero.jpg') center center / cover no-repeat",
        }}
      >
