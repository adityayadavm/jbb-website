...
const relatedServices = [
  ...
  { icon: Building2,       title: "Business Formation & Advisory",      desc: "Private Limited, LLP, OPC, and all entity types — end-to-end formation.", href: "/services/business-formation-advisory" },
  { icon: Globe,           title: "Accounting, Reporting & Assurance",  desc: "Bookkeeping, financial statements, MIS reporting, and assurance review.", href: "/services/accounting-reporting-assurance" },
];
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(rgba(3,12,28,0.84), rgba(3,12,28,0.76)), url('/bg/gst-advisory-hero.jpg') center center / cover no-repeat",
        }}
      >
